// Competition Code for Car, Including Injection Servo Code
// Update Log
// 2023-10-31 Michael Chan
...
const int stop_option = 2; // Two 1 - first diff with 1 time point between, 2 - first diff with 4 time points between
